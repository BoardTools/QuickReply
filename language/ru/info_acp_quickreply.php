...
$lang = array_merge($lang, array(
	...
	'ACP_QUICKREPLY_TITLE_EXPLAIN'         => 'Здесь вы можете задать основные и форумные настройки для формы быстрого ответа.
												<br />ПРИМЕЧАНИЕ: настройки «Разрешить быстрый ответ» и «Включить быстрый ответ»
												встроены в движок phpBB и представлены здесь для удобства и полноты.
												Другие представленные здесь настройки зависят от них.',
	//
	...
	'ACP_QUICKREPLY_QN_TITLE_EXPLAIN'      => 'Здесь вы можете задать настройки быстрой цитаты и обращения по нику.
												<br />ПРИМЕЧАНИЕ: эти настройки не применяются в форумах, в которых 
												быстрый ответ выключен, или в случае, если быстрый ответ не разрешён.',
	//
	...
	'ACP_QUICKREPLY_PLUGINS_TITLE_EXPLAIN' => 'Здесь вы можете задать настройки для особых функций, включённых в расширение
												для быстрого ответа.<br />ПРИМЕЧАНИЕ: эти настройки применяются независимо от того, 
												включён ли быстрый ответ в конкретном форуме.',
	//
	'ACP_QR_AJAX_PAGINATION'               => 'Включить просмотр тем без перезагрузки страницы',
	'ACP_QR_AJAX_PAGINATION_EXPLAIN'       => 'Если эта настройка включена, навигация Ajax будет использована вместо обычной отправки формы при включении пользователями опции «Не очищать форму быстрого ответа
												при просмотре темы».',
	...
	'ACP_QR_AJAX_SUBMIT_EXPLAIN'           => 'Разрешить отправку сообщений без перезагрузки страницы.
												<br />При включении данной опции в необходимых форумах также должна быть включена
												опция Ajax отправки.',
	...
	'ACP_QR_ENABLE_AJAX_SUBMIT_EXPLAIN'    => 'Разрешить использовать Ajax отправку сообщений сразу во всех форумах.
												<br /><em>При выборе «Оставить как есть» форумные настройки не поменяются.</em>',
	'ACP_QR_ENABLE_RE'                     => 'Включить префикс «Re:»',
	'ACP_QR_ENABLE_RE_EXPLAIN'             => 'Автоматически добавлять префикс «Re:» в поле «Заголовок сообщения»
												в формах полного и быстрого ответа.',
	...
	'ACP_QR_FORM_TYPE_EXPLAIN'             => 'При выборе типа «Фиксированный с подгрузкой сообщений» стандартная постраничная навигация 
												будет дополнена возможностью подгружать сообщения на текущую страницу при помощи кнопок показа
												следующих/предыдущих сообщений.
												<br /><em>При выборе «Оставить как есть» форумные настройки не поменяются.</em>',
	...
	'ACP_QR_HIDE_SUBJECT_BOX_EXPLAIN'      => 'Если у пользователя отсутствует право на изменение заголовка сообщения, 
												поле «Заголовок» будет скрыто, а не заблокировано в форме отправки сообщения.',
	'ACP_QR_LAST_QUOTE'                    => 'Включить полное цитирование последних сообщений тем',
	'ACP_QR_LAST_QUOTE_EXPLAIN'            => 'Разрешить возможность полного цитирования с помощью стандартной кнопки цитаты.
												<br /><em>Обратите внимание на то, что кнопка цитаты будет скрыта, 
												если эта настройка отключена вместе с настройкой для быстрой цитаты.
												Эта настройка переопределяет право доступа для полной цитаты.</em>',
	...
	'ACP_QR_QUICKNICK_EXPLAIN'             => 'Разрешить вставку никнейма в форму быстрого ответа при клике на надпись 
												«Обратиться по никнейму» в выпадающем меню.<br />Если включено, 
												пользователь сможет переключиться в личном разделе на вариант ссылки
												«Обратиться по никнейму» под аватаром.',
	...
	'ACP_QR_QUICKNICK_REF_EXPLAIN'         => 'BBCode [ref] будет добавляться вместо [b] в функции «Обратиться по никнейму».
												<br /><em>Обратите внимание на то, что при отключении этой настройки пользователи 
												будут получать уведомления об упоминаниях только в том случае, если тег [ref]
												был добавлен в сообщение вручную.</em>',
	...
	'ACP_QR_QUICKQUOTE_BUTTON_EXPLAIN'     => 'Разрешить возможность цитирования по клику на кнопку «Ответить с цитатой».
												<br /><em>Обратите внимание на то, что кнопка цитаты будет скрыта,
												если эта настройка отключена и у пользователя отсутствует право доступа
												для использования полной цитаты.</em>',
