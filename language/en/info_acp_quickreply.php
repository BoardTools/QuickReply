...
$lang = array_merge($lang, array(
	...
	'ACP_QR_LEGEND_FORUM'                  => 'Forum based settings',
	'ACP_QR_LEGEND_FORUM_EXPLAIN'          => 'The options listed here do not display the state of any settings, they can be used to quickly change the settings in all forums regardless of their actual state.',
